...
// Typescript provideS the contcept of function overloading .
// you can have multiple function
// with the same name but diffirent paramaters types and return type.
...
function Umit(a:string, ...names: string[]){
    return  a + " " + names.join(",") + "!"
}
